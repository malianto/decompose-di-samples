...
This is a sample Android project demonstrating the use of [Decompose](https://github.com/arkivanov/Decompose) library together with [Metro](https://github.com/ZacSweers/metro) DI framework.
